...
const LimiterCard = () => {
  return (
    <div className="rounded-xl bg-gradient-card border border-border p-6 shadow-card">
      <h3 className="font-display font-semibold text-lg mb-4">Limiter Analysis</h3>
      ...
      <div className="space-y-4">
        <div className="rounded-lg border border-primary/30 bg-primary/5 p-4">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              <p className="text-xs text-primary font-medium uppercase tracking-wider">Primary Limiter</p>
              <p className="font-display font-bold text-xl">Gymnastics</p>
            </div>
          </div>
          <p className="text-sm text-muted-foreground">
            Gymnastics is your weakest area and limits you the most in metcons with
            bodyweight movements. Focus here for the next 4-6 weeks.
          </p>
        </div>

        <div className="space-y-3">
          <p className="text-sm font-medium text-muted-foreground">Secondary focus areas</p>
